-- =============================================
-- Dev-only: function to seed fake groups and games for a user
-- Run from seed.sql or SQL Editor: SELECT seed_dev_data('your-auth-user-uuid'::uuid);
-- =============================================
...
BEGIN
  ...
  -- Group members (owner in both)
  INSERT INTO group_members (group_id, player_id, display_name, is_anonymous, sort_order)
  VALUES (v_group1_id, p_user_id, 'Seed User', false, 0);
  INSERT INTO group_members (group_id, player_id, display_name, is_anonymous, sort_order)
  ...
  INSERT INTO group_members (group_id, player_id, display_name, is_anonymous, sort_order)
  VALUES (v_group2_id, p_user_id, 'Seed User', false, 0);
  INSERT INTO group_members (group_id, player_id, display_name, is_anonymous, sort_order)
  ...
  -- We need the game_player ids for game2: Seed User slot = v_slot2_id; get Alex slot id
